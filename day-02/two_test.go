...
var basicInput = []string{"1-3 a: abcde", "1-3 b: cdefg", "2-9 c: ccccccccc"}
var advancedInput = []string{
...
func getValidCount(input []string, validator func(input string) bool) int {
	foundCount := 0
...
func TestBaseCase(t *testing.T) {
	expectedSolution := 2
	foundSolution := getValidCount(basicInput, isValidPartOne)
...
func TestAdvancedCase(t *testing.T) {
	expectedSolution := 620
	foundSolution := getValidCount(advancedInput, isValidPartOne)
...
func TestBaseCase2(t *testing.T) {
	expectedSolution := 1
	foundSolution := getValidCount(basicInput, isValidPartTwo)
...
func TestAdvancedCase2(t *testing.T) {
	expectedSolution := 727
	foundSolution := getValidCount(advancedInput, isValidPartTwo)
