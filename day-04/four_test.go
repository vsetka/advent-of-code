...
var basicInputPartOne = `ecl:gry pid:860033327 eyr:2020 hcl:#fffffd
...
var basicInputPartTwo = `eyr:1972 cid:100
...
var advancedInput = `eyr:2029 byr:1931 hcl:z cid:128
...
func TestBaseCasePartOne(t *testing.T) {
	expectedSolution := 2
	foundSolution := countValidPassports(basicInputPartOne, false)
...
func TestAdvancedCasePartOne(t *testing.T) {
	expectedSolution := 233
	foundSolution := countValidPassports(advancedInput, false)
...
func TestBaseCasePartTwo(t *testing.T) {
	expectedSolution := 4
	foundSolution := countValidPassports(basicInputPartTwo, true)
...
func TestAdvancedCasePartTwo(t *testing.T) {
	expectedSolution := 111
	foundSolution := countValidPassports(advancedInput, true)
